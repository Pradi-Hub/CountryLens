        ...
        return (
            <div className="flex items-center justify-center h-screen bg-[#ECEFCA] dark:bg-[#213448]">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-[#213448] dark:text-[#94B4C1]">Loading CountryLens...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="bg-[#ECEFCA] dark:bg-[#213448] min-h-screen text-[#213448] dark:text-[#ECEFCA]">
            ...
            <section className="relative bg-cover bg-center h-screen" style={{
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-[#ECEFCA] p-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link to="/home" className="bg-[#547792] hover:bg-[#94B4C1] hover:text-[#213448] text-[#ECEFCA] px-8 py-3 rounded-lg font-medium text-lg transition-colors">
                            Explore Countries
                        </Link>
                        {!user && (
                            <Link to="/login" className="bg-transparent hover:bg-[#ECEFCA] hover:text-[#213448] text-[#ECEFCA] border-2 border-[#ECEFCA] px-8 py-3 rounded-lg font-medium text-lg transition-colors">
                                Sign In
                            </Link>
                        )}
                    </div>
                ...
                <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
                    <svg className="w-6 h-6 text-[#ECEFCA]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="py-16 bg-[#ECEFCA] dark:bg-[#213448]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-[#213448] dark:text-[#ECEFCA] mb-4">Explore the World with CountryLens</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white dark:bg-[#547792] p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-[#213448] dark:text-[#ECEFCA] mb-2">Detailed Information</h3>
                        ...
                        <div className="bg-white dark:bg-[#547792] p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-[#213448] dark:text-[#ECEFCA] mb-2">Save Favorites</h3>
                            <p className="text-[#547792] dark:text-[#94B4C1]">
                        ...
                        <div className="bg-white dark:bg-[#547792] p-6 rounded-lg shadow-md">
                            ...
                            <h3 className="text-xl font-semibold text-[#213448] dark:text-[#ECEFCA] mb-2">Interactive Maps</h3>
                            <p className="text-[#547792] dark:text-[#94B4C1]">
            ...
            <section className="py-16 bg-white dark:bg-[#547792]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-[#213448] dark:text-[#ECEFCA] mb-4">Explore by Region</h2>
                        <p className="text-lg text-[#547792] dark:text-[#94B4C1] max-w-3xl mx-auto">
                        ...
                        {regions.map((region, index) => (
                            <div key={index} className="relative overflow-hidden rounded-lg group h-64">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-6">
                                    <h3 className="text-xl font-bold text-[#ECEFCA]">{region.name}</h3>
                                    <Link to={`/region/${region.name}`} className="mt-2 inline-block text-[#94B4C1] hover:text-[#ECEFCA] text-sm">
                                        Explore countries →
                                    </Link>
                                </div>
                            </div>
            ...
            <section className="py-16 bg-[#547792]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-[#ECEFCA] mb-4">Ready to Explore the World?</h2>
            ...
            <footer className="bg-[#213448] text-[#94B4C1] py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 border-t border-[#547792] pt-8 flex flex-col md:flex-row justify-between">
                        ...
                        <p className="mt-4 md:mt-0 text-[#94B4C1]">© {new Date().getFullYear()} CountryLens. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
