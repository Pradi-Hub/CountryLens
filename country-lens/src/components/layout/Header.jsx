...
const Header = () => {
    ...
    return (
        <header
            className="sticky top-0 z-50 bg-[#ECEFCA] dark:bg-[#213448] shadow-md transition-colors">
            <div className="container mx-auto px-3 sm:px-4 lg:px-8 xl:px-28 py-2 sm:py-3 flex justify-between items-center">
                ...
                <Link to="/" className="flex items-center space-x-1 sm:space-x-2 group">
                    ...
                    />
                    <span
                        className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#213448] dark:text-[#ECEFCA] drop-shadow-sm group-hover:drop-shadow-lg transition-all duration-300">
                        Country<span className="text-[#547792] dark:text-[#94B4C1]">Lens</span>
                    </span>
                </Link>
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                    ...
                    {user ? (
                        <div className="flex items-center space-x-2 sm:space-x-3">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" viewBox="0 0 20 20"
                                     fill="currentColor">
                                    <path
