...
const Header = () => {
    ...
    return (
        <header className="bg-white shadow-light-shadow dark:shadow-dark-shadow dark:bg-gray-800 transition-colors">
            <div className="container mx-auto px-28 py-3 flex justify-between items-center">
                ...
                <Link to="/" className="flex items-center space-x-2 group">
                    ...
                    />
                    <span className="text-3xl font-bold text-gray-900 dark:text-white drop-shadow-sm group-hover:drop-shadow-lg transition-all duration-300">
                        Country<span className="text-blue-500 dark:text-blue-400">Lens</span>
                    </span>
                </Link>
